...
public class StepCounterListener implements SensorEventListener {
    ...
    public StepCounterListener(TextView stepCountsView, CircularProgressIndicator progressBar, SQLiteDatabase databse, Game_01_Matching activity)
    // ADDED A PARAMETER TO THE FUNCTION, IMPLEMENTED IN LINE 93 AS WELL
    {
        this.stepCountsView = stepCountsView;
        this.database = databse;
        this.progressBar = progressBar;
        this.anotherActivity = activity;
    }
