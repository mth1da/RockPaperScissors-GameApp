...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    /*public static void loadRecords(Context context){
        ...
        String [] columns = new String [] {DatabaseHelper.KEY_TIMESTAMP};
        Cursor cursor = database.query(DatabaseHelper.TABLE_NAME, columns, null, null, DatabaseHelper.KEY_TIMESTAMP,
                null, null );
    ...
    /*public static Integer loadSingleRecord(Context context, String date){
        ...
        String where = DatabaseHelper.KEY_DAY + " = ?";
        String [] whereArgs = { date };

        Cursor cursor = database.query(DatabaseHelper.TABLE_NAME, null, where, whereArgs, null,
                null, null );
    ...
    /*public static void deleteRecords (Context context) {
        ...
        numberDeletedRecords = database.delete(DatabaseHelper.TABLE_NAME, null, null);
        database.close();
